...
Give the previous data pipeline we can identify the items that were excluded, the phse at which they were excluded and details of the code that resulted in them being excluded.
