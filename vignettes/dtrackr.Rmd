...
* TODO: default values for message and headline that capture all operations
* capturing the operation name in the history graph in a way that makes it easy to put into the glue spec.
