...
title: 'dtrackr: Track your Data Pipelines'
---
...
Sometimes part of my pipeline is designed to change depending on a specific parameter, for example an age cut-off, which I tweak and re-run. 
